  ...
  var ScrollSpy = /*#__PURE__*/ (function () {
    ...
    _proto.refresh = function refresh() {
      ...
      targets
        .map(function (element) {
          var target
          var targetSelector = Util__default["default"].getSelectorFromElement(
            element
          )
    ...
    _proto._getConfig = function _getConfig(config) {
      ...
      if (
        ...
        Util__default["default"].isElement(config.target)
      ) {
    ...
    _proto._activate = function _activate(target) {
      ...
      if ($link.hasClass(CLASS_NAME_DROPDOWN_ITEM)) {
        ...
        $link
          ...
          .addClass(CLASS_NAME_ACTIVE) // Handle special case when .nav-link is inside .nav-item
