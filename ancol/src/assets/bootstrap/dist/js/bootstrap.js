...
;(function (global, factory) {
  ...
  var Carousel = /*#__PURE__*/ (function () {
    ...
    _proto._addTouchEventListeners = function _addTouchEventListeners() {
      ...
      if (this._pointerEvent) {
        $__default["default"](this._element).on(EVENT_POINTERDOWN, function (
          event
        ) {
          return start(event)
        })
        $__default["default"](this._element).on(EVENT_POINTERUP, function (
          event
        ) {
          return end(event)
        })
        ...
        $__default["default"](this._element).on(EVENT_TOUCHSTART, function (
          event
        ) {
          return start(event)
        })
        $__default["default"](this._element).on(EVENT_TOUCHMOVE, function (
          event
        ) {
          return move(event)
        })
        $__default["default"](this._element).on(EVENT_TOUCHEND, function (
          event
        ) {
          return end(event)
        })
  ...
  var Modal = /*#__PURE__*/ (function () {
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        $__default["default"](this._element).on(EVENT_CLICK_DISMISS, function (
          event
        ) {
  ...
  $__default["default"](document).on(
    ...
    function (event) {
      ...
      var $target = $__default["default"](target).one(EVENT_SHOW$2, function (
        showEvent
      ) {
        if (showEvent.isDefaultPrevented()) {
  ...
  var ScrollSpy = /*#__PURE__*/ (function () {
    function ScrollSpy(element, config) {
      ...
      $__default["default"](this._scrollElement).on(EVENT_SCROLL, function (
        event
      ) {
